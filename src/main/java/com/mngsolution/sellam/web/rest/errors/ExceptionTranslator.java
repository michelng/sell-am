package com.mngsolution.sellam.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.mngsolution.sellam.service.EmailAlreadyUsedException ||
            ex instanceof com.mngsolution.sellam.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.mngsolution.sellam.service.InvalidPasswordException
