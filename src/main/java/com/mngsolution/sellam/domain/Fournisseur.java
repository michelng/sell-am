...
public class Fournisseur implements Serializable {
    ...
    public Fournisseur nomResponsable(String nomResponsable) {
    ...
    public Fournisseur telephone1(String telephone1) {
    ...
    public Fournisseur telephone2(String telephone2) {
    ...
    public Fournisseur statut(Statut statut) {
