...
import { Entreprise } from '../../../......mainwebappapp/shared/model/entreprise.model';
...
describe('Service Tests', () => {
  describe('Entreprise Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Entreprise(123, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'ACTIF');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should partial update a Entreprise', async () => {
      ...
      it('should not partial update a Entreprise', async () => {
