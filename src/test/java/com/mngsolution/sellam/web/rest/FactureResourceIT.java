...
import com.mngsolution.sellam.service.mapper.FactureMapper;
...
class FactureResourceIT {
    ...
    void createFacture() throws Exception {
        ...
        assertThat(testFacture.getMontantTotal()).isEqualByComparingTo(DEFAULT_MONTANT_TOTAL);
        assertThat(testFacture.getCommentaire()).isEqualTo(DEFAULT_COMMENTAIRE);
        assertThat(testFacture.getStatutPaiement()).isEqualTo(DEFAULT_STATUT_PAIEMENT);
    }
    ...
    void putExistingFacture() throws Exception {
        ...
        assertThat(testFacture.getMontantTotal()).isEqualByComparingTo(UPDATED_MONTANT_TOTAL);
        assertThat(testFacture.getCommentaire()).isEqualTo(UPDATED_COMMENTAIRE);
        assertThat(testFacture.getStatutPaiement()).isEqualTo(UPDATED_STATUT_PAIEMENT);
    }
    ...
    void partialUpdateFactureWithPatch() throws Exception {
        ...
        partialUpdatedFacture.dateFacture(UPDATED_DATE_FACTURE).dateEcheance(UPDATED_DATE_ECHEANCE).commentaire(UPDATED_COMMENTAIRE);
